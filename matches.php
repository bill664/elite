...
<header>
  <nav class="container">
        <div class="logo">EliteFootball</div>
        <ul class="nav-links">            
            <li><a href="logout.php">Logout</a></li>
        </ul>
        <a href="admin.php"><button class="admin-btn">Admin Portal</button></a>
    </nav>
</header>
</head>
<body>
...
?>
        <div class="match-card">
            <h3><?php echo $row['team_home']; ?> vs <?php echo $row['team_away']; ?></h3>
            <p><strong>Prediction:</strong> <?php echo $row['prediction']; ?></p>
            <p><strong>Home Odds:</strong> <?php echo $row['odds_home']; ?></p>
            <p><strong>Draw Odds:</strong> <?php echo $row['odds_draw']; ?></p>
            <p><strong>Away Odds:</strong> <?php echo $row['odds_away']; ?></p>
            <p><strong>Form:</strong> <?php echo $row['form_home']; ?> - <?php echo $row['form_away']; ?></p>
            <p><em>Posted on: <?php echo $row['created_at']; ?></em></p>
            <p>Status: 
                <?php if ($row['status'] === 'correct'): ?>
                    <span class="status-label correct">✔ Correct</span>
                <?php elseif ($row['status'] === 'wrong'): ?>
                    <span class="status-label wrong">✖ Wrong</span>
                <?php else: ?>
...
<?php
        ...
        echo "<p>No predictions available.</p>";
    endif;
}
?>
