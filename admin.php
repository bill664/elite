...
<form method="POST"  action="adminprocess.php">
 <marquee>
    <h2>THE MOST ASSURE PREDICTION</h2>
    <h2>90% prediction accurate</h2>
</marquee>

<form action="predictionprocess.php" method="POST" style="max-width:600px; margin:auto; background:#f4f4f4; padding:20px; border-radius:10px;">
    ...
    <input type="text" name="prediction" required><br><br>

    <label>Home Odds:</label>
    <input type="number" step="0.01" name="odds_home" required><br><br>

    <label>Draw Odds:</label>
    <input type="number" step="0.01" name="odds_draw" required><br><br>

    <label>Away Odds:</label>
    <input type="number" step="0.01" name="odds_away" required><br><br>

    <label>Home Team Form:</label>
    <input type="text" name="form_home" required><br><br>

    <label>Away Team Form:</label>
    <input type="text" name="form_away" required><br><br>
    ...
    <?php if ($result && $result->num_rows > 0): ?>
        <table border="1">
            ...
            <tr>
                <td><?= $row['id'] ?></td>
                <td><?= $row['team_home'] ?> vs <?= $row['team_away'] ?></td>
                <td><?= $row['prediction'] ?></td>
                <td>
                    <a href="edit_prediction.php?id=<?= $row['id'] ?>">Edit</a>
                    <a href="delete_prediction.php?id=<?= $row['id'] ?>" onclick="return confirm('Delete this prediction?')">Delete</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </table>
    <?php else: ?>
        <p>No predictions posted yet.</p>
    <?php endif; ?>
</body>
    ...
    <div class="container">
        <div class="footer-content">
            <div class="footer-section">
                <h3>EliteFootball</h3>
                <p>The world's most exclusive sports betting platform, specializing in premium football matches between the greatest teams.</p>
            </div>
            <div class="footer-section">
                <h3>Quick Links</h3>
                <a href="home.php">Home</a>
                <a href="matches.php">Premium Matches</a>
                <a href="contact.php">Join Elite Circle</a>
                <a href="register.php">Register</a>
            </div>
            <div class="footer-section">
                <h3>Contact Information</h3>
                <p>Email: elite@elitefootball.com</p>
                <p>Phone: +1 (555) 123-ELITE</p>
                <p>VIP Support: Available 24/7</p>
                <p>Address: 123 Elite Boulevard, Premium District</p>
            </div>
        </div>
        <div class="footer-bottom">
            <p>&copy; 2025 EliteFootball. All rights reserved. Please bet responsibly.</p>
        </div>
    </div>
</footer>
