...
<body>
  <div class="container" style="padding-top: 150px;">
    ...
    <form class="admin-form" method="POST" action="loginprocess.php">
        ...
        <button class="submit-btn" type="submit" href="matches.php" >Login</button>
    </form>
</div> 
</body>  
    ...
    <div class="container">
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <a href="register.php">Join Elite Circle</a>
